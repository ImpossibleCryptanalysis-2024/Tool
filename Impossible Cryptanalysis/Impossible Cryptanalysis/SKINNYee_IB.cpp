...
void keySchedule(GRBModel& model, vector<vector<vector<GRBVar>>>& roundkey) {
	...
	// 
	// counter for s0|s1=11 and k=1 in ROUND rounds：0,1,2,ROUND
	for (int i = 0; i < state; i++) {
		GRBQuadExpr KS = 0;
		int j = i;
		for (int r = 0; r < ROUND; r++) {
			KS += roundkey[r][j][0] * roundkey[r][j][1];
			j = pp[j];
		}
		GRBVar e = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addQConstr(KS <= ROUND - (ROUND - 3) * e);
		model.addQConstr(KS >= ROUND - ROUND * e);
	}
...
void MixColumns_U(GRBModel& model, vector<vector<vector<GRBVar>>>& StateW, vector<vector<vector<GRBVar>>>& StateX) {
	for (int r = 0; r < ROUND - 1; r++) {
		...
		for (int col = 0; col < 4; col++) {
			...
			{
				// Row 0
				//_3XOR_deterministic(model, StateW[r][col][0], StateW[r][col][1], StateW[r][col + 8][0], StateW[r][col + 8][1], StateW[r][col + 12][0], StateW[r][col + 12][1], StateX[r + 1][col][0], StateX[r + 1][col][1], StateW[r][col][2]);
			...
			// In Key-Recovery (Wd = 0): Probabilistic Extension <-
			{
				...
				// Row 1
				//_3XOR_probabilistic(model, StateX[r + 1][col + 4][0], StateX[r + 1][col + 4][1], StateX[r + 1][col + 8][0], StateX[r + 1][col + 8][1], StateX[r + 1][col + 12][0], StateX[r + 1][col + 12][1], StateW[r][col + 4][0], StateW[r][col + 4][1], Wd_Not);
			...
			//// Probabilistic Extension for key recovery ->
			//{
			//	GRBVar Wd_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
			//	model.addConstr(Wd_Not == 1 - StateW[r][col][2]);
			//	// Row 0
			//	//_3XOR_deterministic(model, StateW[r][col][0], StateW[r][col][1], StateW[r][col + 8][0], StateW[r][col + 8][1], StateW[r][col + 12][0], StateW[r][col + 12][1], StateX[r + 1][col][0], StateX[r + 1][col][1], StateW[r][col][2]);
			//	_2XOR_probabilistic(model, StateX[r + 1][col + 12][0], StateX[r + 1][col + 12][1], StateW[r][col + 12][0], StateW[r][col + 12][1], StateX[r + 1][col][0], StateX[r + 1][col][1], Wd_Not);
			//	// Row 1
			//	model.addConstr(StateW[r][col][0] == StateX[r + 1][col + 4][0]);
			//	model.addConstr(StateW[r][col][1] == StateX[r + 1][col + 4][1]);
			//	// Row 2
			//	_2XOR_probabilistic(model, StateW[r][col + 4][0], StateW[r][col + 4][1], StateW[r][col + 8][0], StateW[r][col + 8][1], StateX[r + 1][col + 8][0], StateX[r + 1][col + 8][1], Wd_Not);
			//	// Row 3
			//	_2XOR_probabilistic(model, StateW[r][col][0], StateW[r][col][1], StateW[r][col + 8][0], StateW[r][col + 8][1], StateX[r + 1][col + 12][0], StateX[r + 1][col + 12][1], Wd_Not);
			//}
	...
	for (int r = 0; r < ROUND - 1; r++) {
		...
		for (int col = 0; col < 4; col++) {
			...
			// In Key-Recovery (Xd = 0): Probabilistic Extension ->
			{
				...
				// Row 0
				//_3XOR_deterministic(model, StateW[r][col][0], StateW[r][col][1], StateW[r][col + 8][0], StateW[r][col + 8][1], StateW[r][col + 12][0], StateW[r][col + 12][1], StateX[r + 1][col][0], StateX[r + 1][col][1], Xd_Not);
			...
			//// In Key-Recovery (Xd = 0): Probabilistic Extension for key-recovery <-
			//{
			//	GRBVar Xd_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
			//	model.addConstr(Xd_Not == 1 - StateX[r + 1][col][2]);
			//	// Row 0
			...
			//	model.addConstr(StateW[r][col][1] == StateX[r + 1][col + 4][1]);
			//	// Row 1
			//	_2XOR_probabilistic(model, StateW[r][col + 8][0], StateW[r][col + 8][1], StateX[r + 1][col + 8][0], StateX[r + 1][col + 8][1], StateW[r][col + 4][0], StateW[r][col + 4][1], Xd_Not);
			//	// Row 2
			//	_2XOR_probabilistic(model, StateX[r + 1][col + 4][0], StateX[r + 1][col + 4][1], StateX[r + 1][col + 12][0], StateX[r + 1][col + 12][1], StateW[r][col + 8][0], StateW[r][col + 8][1], Xd_Not);
			//	// Row 3
			//	_2XOR_probabilistic(model, StateX[r + 1][col][0], StateX[r + 1][col][1], StateX[r + 1][col + 12][0], StateX[r + 1][col + 12][1], StateW[r][col + 12][0], StateW[r][col + 12][1], Xd_Not);
			//}
...
void BeyondFullCodebook(GRBModel& model, vector<vector<GRBVar>>& Up_plaintext, vector<vector<GRBVar>>& Lo_ciphertext, vector<vector<vector<GRBVar>>>& Up_StateX, vector<vector<vector<GRBVar>>>& Up_StateY, vector<vector<vector<GRBVar>>>& Lo_StateX, vector<vector<vector<GRBVar>>>& Lo_StateW) {
	...
	//model.addConstr(cB <= rB);// +2);
	//model.addConstr(cF <= rF);
	model.addConstr(cF + cB <= rF + rB);
}
...
void KeyBridge(GRBModel& model, vector<vector<vector<GRBVar>>>& Up_Roundkey, vector<vector<vector<GRBVar>>>& Lo_Roundkey, GRBQuadExpr& key_involved_independent, vector<GRBVar>& independent) {
	...
	for (int i = 8; i < state; i++) {
		...
		for (int r = 0; r < midRound; r++) {
			if (r % 4 == 0) cnt0 += Up_Roundkey[r][i][2];
			if (r % 4 == 1) cnt1 += Up_Roundkey[r][i][2];
			if (r % 4 == 2) cnt2 += Up_Roundkey[r][i][2];
			if (r % 4 == 3) cnt3 += Up_Roundkey[r][i][2];

		}

		for (int r = midRound; r < ROUND; r++) {
			if (r % 4 == 0) cnt0 += Lo_Roundkey[r][i][2];
			if (r % 4 == 1) cnt1 += Lo_Roundkey[r][i][2];
			if (r % 4 == 2) cnt2 += Lo_Roundkey[r][i][2];
			if (r % 4 == 3) cnt3 += Lo_Roundkey[r][i][2];
		}
		...
		GRBVar Ind3 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		...
		model.addGenConstrIndicator(Ind3, 0, cnt3 <= 0);
		model.addGenConstrIndicator(Ind3, 1, cnt3 >= 1);

		independent[i - 8] = model.addVar(0.0, GRB_INFINITY, 0.0, GRB_INTEGER);
		...
		model.addConstr(independent[i - 8] == cnt0);
		model.addConstr(independent[i] == cnt1);
		model.addConstr(independent[i + 8] == cnt2);
		model.addConstr(independent[i + 16] == cnt3);

		key_involved_independent += (Ind0 + Ind1 + Ind2 + Ind3);
	}
}
...
void Em_Construct_BCT(GRBModel& model, vector<vector<vector<GRBVar>>>& Up_StateX, vector<vector<vector<GRBVar>>>& Lo_StateY) {
	...
	model.addGenConstrIndicator(c, 0, Em_1r == 0);
	model.addGenConstrIndicator(c, 1, Em_1r >= 1);
	model.addConstr(c == 1);
}

void Em_Construct_IB_All(GRBModel& model, vector<vector<vector<GRBVar>>>& Up_StateX, vector<vector<vector<GRBVar>>>& Lo_StateY, vector<vector<GRBVar>>& cond) {
	// 1-round Em 
	// with [BCT]
	{
		GRBLinExpr Em_1r = 0;
	...
	// 2-round Em 
	// with [DDT+BCT]
	// Row 0 of MixColumns: X_r[i,8+(i+2)%4,12+(i+1)%4]\in{z,z,k}, Y_r+1[i]=k, i\in{0,1,2,3}
	for (int i = 0; i < 4; i++) {
		GRBLinExpr Xs1_Sum = Up_StateX[midRound][i][1] + Up_StateX[midRound][8 + (i + 2) % 4][1] + Up_StateX[midRound][12 + (i + 1) % 4][1];
		GRBVar Em_Ind1 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind1, 1, Xs1_Sum == 3);
		model.addGenConstrIndicator(Em_Ind1, 0, Xs1_Sum <= 2);

		GRBLinExpr Xs0_Sum = Up_StateX[midRound][i][0] + Up_StateX[midRound][8 + (i + 2) % 4][0] + Up_StateX[midRound][12 + (i + 1) % 4][0];
		GRBVar Em_Ind2 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind2, 1, Xs0_Sum <= 2);
		model.addGenConstrIndicator(Em_Ind2, 0, Xs0_Sum == 3);

		GRBVar Ys0_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addConstr(Ys0_Not == 1 - Lo_StateY[midRound + 1][i][0]);
		GRBVar Em_And[4] = { Em_Ind1,Em_Ind2,Ys0_Not,Lo_StateY[midRound + 1][i][1] };

		cond[1][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[1][i], Em_And, 4);
	}

	// Row 1 of M & Row 1 of M^{-1}: X_r[i]=k, Y_r+1[i+4]=k, i\in{0,1,2,3}
	for (int i = 0; i < 4; i++) {
		GRBVar Xs0_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addConstr(Xs0_Not == 1 - Up_StateX[midRound][i][0]);
		GRBVar Ys0_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		...
		GRBVar Em_And[4] = { Xs0_Not,Up_StateX[midRound][i][1],Ys0_Not,Lo_StateY[midRound + 1][i + 4][1] };

		cond[2][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[2][i], Em_And, 4);
	}

	// Row 2 of M: 
	for (int i = 0; i < 4; i++) {
		GRBLinExpr Xs1_Sum = Up_StateX[midRound][4 + (i + 3) % 4][1] + Up_StateX[midRound][8 + (i + 2) % 4][1];
		GRBVar Em_Ind1 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind1, 1, Xs1_Sum == 2);
		model.addGenConstrIndicator(Em_Ind1, 0, Xs1_Sum <= 1);

		GRBLinExpr Xs0_Sum = Up_StateX[midRound][4 + (i + 3) % 4][0] + Up_StateX[midRound][8 + (i + 2) % 4][0];
		GRBVar Em_Ind2 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind2, 1, Xs0_Sum <= 1);
		model.addGenConstrIndicator(Em_Ind2, 0, Xs0_Sum == 2);

		GRBVar Ys0_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addConstr(Ys0_Not == 1 - Lo_StateY[midRound + 1][i + 8][0]);
		GRBVar Em_And[4] = { Em_Ind1,Em_Ind2,Ys0_Not,Lo_StateY[midRound + 1][i + 8][1] };

		cond[3][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[3][i], Em_And, 4);
	}
	// Row 3 of M: 
	for (int i = 0; i < 4; i++) {
		...
		GRBVar Em_And[4] = { Em_Ind1,Em_Ind2,Ys0_Not,Lo_StateY[midRound + 1][i + 12][1] };

		cond[4][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[4][i], Em_And, 4);
	}
	...
	for (int i = 0; i < 4; i++) {
		...
		GRBVar Em_Ind1 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind1, 1, Ys1_Sum == 3);
		model.addGenConstrIndicator(Em_Ind1, 0, Ys1_Sum <= 2);

		GRBLinExpr Ys0_Sum = Lo_StateY[midRound + 1][i + 4][0] + Lo_StateY[midRound + 1][i + 8][0] + Lo_StateY[midRound + 1][i + 12][0];
		GRBVar Em_Ind2 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind2, 1, Ys0_Sum <= 2);
		model.addGenConstrIndicator(Em_Ind2, 0, Ys0_Sum == 3);

		GRBVar Xs0_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addConstr(Xs0_Not == 1 - Up_StateX[midRound][4 + (i + 3) % 4][0]);
		GRBVar Em_And[4] = { Em_Ind1,Em_Ind2,Xs0_Not,Up_StateX[midRound][4 + (i + 3) % 4][1] };

		cond[5][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[5][i], Em_And, 4);
	}
	// Row 2 of M^{-1}
	for (int i = 0; i < 4; i++) {
		GRBLinExpr Ys1_Sum = Lo_StateY[midRound + 1][i + 4][1] + Lo_StateY[midRound + 1][i + 12][1];
		GRBVar Em_Ind1 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind1, 1, Ys1_Sum == 2);
		model.addGenConstrIndicator(Em_Ind1, 0, Ys1_Sum <= 1);

		GRBLinExpr Ys0_Sum = Lo_StateY[midRound + 1][i + 4][0] + Lo_StateY[midRound + 1][i + 12][0];
		GRBVar Em_Ind2 = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrIndicator(Em_Ind2, 1, Ys0_Sum <= 1);
		model.addGenConstrIndicator(Em_Ind2, 0, Ys0_Sum == 2);

		GRBVar Xs0_Not = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addConstr(Xs0_Not == 1 - Up_StateX[midRound][8 + (i + 2) % 4][0]);
		GRBVar Em_And[4] = { Em_Ind1,Em_Ind2,Xs0_Not,Up_StateX[midRound][8 + (i + 2) % 4][1] };

		cond[6][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[6][i], Em_And, 4);
	}
	// Row 3 of M^{-1}
	for (int i = 0; i < 4; i++) {
		...
		GRBVar Em_And[4] = { Em_Ind1,Em_Ind2,Xs0_Not,Up_StateX[midRound][12 + (i + 1) % 4][1] };

		cond[7][i] = model.addVar(0.0, 1.0, 0.0, GRB_BINARY);
		model.addGenConstrAnd(cond[7][i], Em_And, 4);
	}
...
void Output_Print(GRBModel& model, vector<vector<vector<GRBVar>>>& Up_Roundkey, vector<vector<vector<GRBVar>>>& Lo_Roundkey, vector<vector<GRBVar>>& Up_plaintext, vector<vector<GRBVar>>& Up_ciphertext, vector<vector<vector<GRBVar>>>& Up_StateX, vector<vector<vector<GRBVar>>>& Up_StateY, vector<vector<vector<GRBVar>>>& Up_StateZ, vector<vector<vector<GRBVar>>>& Up_StateW, vector<vector<GRBVar>>& Lo_plaintext, vector<vector<GRBVar>>& Lo_ciphertext, vector<vector<vector<GRBVar>>>& Lo_StateX, vector<vector<vector<GRBVar>>>& Lo_StateY, vector<vector<vector<GRBVar>>>& Lo_StateZ, vector<vector<vector<GRBVar>>>& Lo_StateW, vector<vector<GRBVar>>& cond, vector<GRBVar>& independent, GRBLinExpr obj1, GRBLinExpr obj2, GRBLinExpr obj3, GRBQuadExpr obj4) {
	...
	for (int r = midRound; r < ROUND; r++) {
		...
		for (int i = 0; i < 4; i++) {
			for (int j = 0; j < 4; j++) {
				cout << Lo_Roundkey[r][4 * i + j][0].get(GRB_DoubleAttr_X) << Lo_Roundkey[r][4 * i + j][1].get(GRB_DoubleAttr_X) << Lo_Roundkey[r][4 * i + j][2].get(GRB_DoubleAttr_X) << Lo_Roundkey[r][4 * i + j][3].get(GRB_DoubleAttr_X) << Lo_Roundkey[r][4 * i + j][4].get(GRB_DoubleAttr_X) << ' ';
			}
		} cout << endl;
...
int main() {
	try {
		...
		AddRoundKey_L(model, Lo_Roundkey, Lo_StateY, Lo_StateZ);
		...
		InvolvedRoundkeys_L(model, Lo_Roundkey, Lo_StateX, Lo_StateW);

		// Key-Recovery
		KeyRecovery_U(model, Up_Roundkey, Up_StateX, Up_StateY);
		KeyRecovery_L(model, Lo_Roundkey, Lo_StateX, Lo_StateY);
		...
		vector<vector<GRBVar>> cond(8, vector<GRBVar>(4));
		Em_Construct_IB_All(model, Up_StateX, Lo_StateY, cond);
		//Em_Construct_BCT(model, Up_StateX, Lo_StateY);

		//// Prefix minimum R_dist with previous results
		//model.addConstr(Up_StateY[5][0][2] == 1);
		//model.addConstr(Lo_StateX[23][0][2] == 1);
